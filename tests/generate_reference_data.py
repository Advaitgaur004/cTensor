...
def tensor_to_list(tensor: torch.Tensor) -> List[float]:
    """Convert PyTorch tensor to flat list of floats."""
    return tensor.detach().cpu().flatten().tolist()

def generate_test_tensors() -> Dict[str, Any]:
    """Generate various test tensors with different shapes and values."""
    test_data = {}
...
def generate_arithmetic_operations() -> Dict[str, Any]:
    """Generate reference data for arithmetic operations."""
    results = {}
...
def generate_matrix_operations() -> Dict[str, Any]:
    """Generate reference data for matrix operations."""
    results = {}
...
def generate_reduction_operations() -> Dict[str, Any]:
    """Generate reference data for reduction operations."""
    results = {}
...
def generate_activation_functions() -> Dict[str, Any]:
    """Generate reference data for activation functions."""
    results = {}
...
def generate_loss_functions() -> Dict[str, Any]:
    """Generate reference data for loss functions."""
    results = {}
...
def generate_neural_network_operations() -> Dict[str, Any]:
    """Generate reference data for neural network operations."""
    results = {}
...
def main():
    """Generate all reference data and save to JSON files."""
